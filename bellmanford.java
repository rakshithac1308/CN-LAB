...
public static final int MAX_VALUE = 999; public BellmanFord(int num_ver) 
{ 
...
Scanner scanner = new Scanner(System.in); System.out.println("Enter the number of vertices"); num_ver = scanner.nextInt(); 
